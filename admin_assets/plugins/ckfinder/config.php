...
*/
$baseUrl = 'http://'.$_SERVER['SERVER_NAME'].'/eshoppingstore/admin_assets/plugins/ckfinder/userfiles/';
//$baseUrl = 'http://'.$_SERVER['SERVER_NAME'].'/fidem-new/admin/ckfinder/userfiles/';



//$baseUrl =  'http://localhost/jbpu/admin/ckfinder/userfiles/';
