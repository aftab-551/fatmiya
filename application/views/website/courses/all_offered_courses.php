        ...
        <div class="row align-items-center">
            <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                <div class="breadcrumbs-content">
                    ...
                    <p>All the courses that have been offered. You can enroll in these courses and learn according to your pace.</p>
                </div>
                <ul class="breadcrumb-nav">
                    <li><a href="<?= base_url('Home'); ?>">Home</a></li>
                    <li>Offered Courses</li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    function ajax_events(page_url){
        var base_url = '<?php echo site_url('courses/ajax_offered_courses') ?>';
