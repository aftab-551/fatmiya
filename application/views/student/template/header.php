...
<html>
  <head>
    ...
    <title>Fatimiya Islamic Center</title>
    ...
    <link rel="stylesheet" href="<?=base_url();?>assets/studentResult/css/table.css">
    <!-- Font Awesome -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?=base_url();?>student/Dashboard" class="logo">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="<?=base_url();?>admin_assets/#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?= $this->session->userdata('student_firstname').' '.$this->session->userdata('student_lastname'); ?></span>
                </a>
...
<!--                    <div class="pull-left">
                    ...
                    <div class="pull-right">
                      <a href="<?=  base_url();?>student/Dashboard/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
