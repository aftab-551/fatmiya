...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <?= form_open(base_url('student/Result/view_result'), 'role="form" name="view_result"') ?>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input name="semesterid"  type="number" data-minlength="4" class="form-control" id="name" placeholder="Enter Semester Number" required>
                            </div>
