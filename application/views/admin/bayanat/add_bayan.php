    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Add Bayan</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="bayan" value="<?= set_value('bayan'); ?>" type="bayan" data-minlength="3" class="form-control" id="bayan" placeholder="Enter bayan" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input name='date'  type="text" class="form-control pull-right" id="datepicker" data-date-format="yyyy-mm-dd"> 
                                </div>
                                <!-- /.input group -->
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input type="file" id="bayan_image" name="bayan_image">
                                <p id="add_image_error"></p>
                            </div>

                            <div class="form-group">
                                <label for="bayan_image">Bayan Audio *</label>
                                <input type="file" id="bayan_audio" name="bayan" required>
...
<script type="text/javascript">
    ...
    function get_action() {
        return '<?= base_url(); ?>admin/Bayanat/insert_bayan';
    }
     //Date picker
