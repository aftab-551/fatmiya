                            ...
                            <tbody>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?= base_url() ?>admin/Students/change_status/<?= rtrim(base64_encode('3'),'='); ?>/<?=  rtrim(base64_encode($student->id),'=');?>" data-id="Nw_0" class="btn btn-default status" title="Activate">
