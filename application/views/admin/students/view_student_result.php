...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <?= form_open(base_url('admin/Students/view_students_result1'), 'role="form" name="add_course_detail"') ?>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                <label for="name">Enter Offered Course ID</label>
                                <input name="courseid"  type="number" data-minlength="4" class="form-control" id="name" placeholder="Enter Course ID" required>
                            </div>
