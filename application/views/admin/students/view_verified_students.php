        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="verified-students" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>First Name</th>
                            ...
                            <tbody>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?= base_url() ?>admin/Students/change_status/<?= rtrim(base64_encode('1'),'='); ?>/<?=  rtrim(base64_encode($student->id),'=');?>" data-id="Nw_0" class="btn btn-default status" title="Deactivate">
