...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <?= form_open_multipart(base_url('admin/Slider/insert_slider'), 'id="add_slider" name="add_slider" role="form"') ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="slider_title" value="<?= set_value('slider_title'); ?>" type="text" class="form-control" id="slider-title" placeholder="Enter Slider Title">
                            </div>

                            <div class="form-group">
                                <label for="description">Slider Description</label>
                                <input name="description" value="<?= set_value('description'); ?>" type="text" class="form-control" id="description" placeholder="Enter Description">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="events" id="events" class="select2" style="width: 100%; padding-left:0; margin-top: -4px;">
                                    ...
                                    <?php foreach($events as $e): ?>
                                        <option value="<?= $e->id; ?>" <?php if(isset($event_id)): ?> <?= $e->id == $event_id ? 'selected' : '';  ?> <?php endif; ?>><?= $e->title.' '. $e->start_date ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="btn_title" value="<?= set_value('btn_title'); ?>" type="text" class="form-control" id="btn-title" placeholder="Enter Button Title">
                            </div>

                            <div class="form-group">
                                <label for="btn-link">Button Link</label>
                                <input name="btn_link" value="<?= set_value('btn_link'); ?>" type="text" class="form-control" id="btn-link" placeholder="Enter link">
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input name="sortField" value="<?= set_value('sortField'); ?>" type="text" data-minlength="3" class="form-control" id="sortField" placeholder="Enter Slider Priority" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="slider_image">Slider Image *</label>
                                <input type="file" id="slider_image" name="slider_image" required>
