...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <?= form_open_multipart(base_url('admin/Blogs/update_blog/'.rtrim(base64_encode($post->id),'=')), 'role="form" name="edit_blog"') ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category" class="select2" style="width: 100%; padding-left:0; margin-top: -4px;">
                                ...
                                <select name="sub_category_id" id="sub-category" class="select2" style="width: 100%; padding-left:0; margin-top: -4px;" required>
                                    <option value="">Select One</option>
                                        <?php if(isset($sub_cat)): ?> 
                                            <option value="<?= $sub_cat->id_sub_categories; ?>" 
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input name="title" value="<?= set_value('title', $post->title); ?>" type="text" class="form-control" id="title" placeholder="Enter Title" required>
                            </div>

                            <div class="form-group">
                                <label for="slug">Slug</label>
                                <input name="slug" value="<?= set_value('slug', $post->slug); ?>" type="text" class="form-control" pattern="[a-zA-Z0-9\-]+" id="slug" placeholder="Enter Slug" title="The slug can only contain a '-', no other characters including space is allowed and it must be unique" required>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input name="description" value="<?= set_value('description', $post->excerpt); ?>" type="text" class="form-control" id="desc" placeholder="Enter Description" required>
                            </div>

                            <div class="form-group">
                                <label for="dd">Body</label>
                                <textarea id="editor" name="body"><?= isset($blog_body) ?  $blog_body : $data = str_replace('&','&amp',$post->body); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="tags" name="tags[]" class="form-control select2 chosen-select" style="width: 100%;" required="" multiple="multiple">
                                    ...
                                    <?php foreach($tags as $t): ?>
                                        ...
                                        <?php endforeach;?>
                                        <?php elseif(isset($tags_tagged)): 
                                                foreach($tags_tagged as $tagged): ?>
                                                    <?= $t->id == $tagged->tag_id ? 'selected' : ''; ?>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                        > 
                                        <?= $t->name;?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="blog-image" name="blog_image">
