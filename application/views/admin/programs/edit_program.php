...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <?= form_open_multipart(base_url('admin/Programs/update_program/'.rtrim(base64_encode($program->id),'=')), 'role="form" name="update_program"') ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" value="<?= set_value('name', $program->name); ?>" type="text" class="form-control" id="program-name" placeholder="Enter name" required>
                            </div>

                            <div class="form-group">
                                <textarea id="editor" name="description"><?= isset($program_description) ?  $program_description : $data = str_replace('&','&amp',$program->description); ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="program-thumbnail">Program Thumbnail</label>
                                <input type="file" id="program-thumbnail" name="program_thumbnail">
                                <p>Size 550 x 340</p>
