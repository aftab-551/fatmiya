                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="under_category" class="form-control select2" style="width: 100%;" required="">
                                    ...
                                    <?php if($category->id_sub_categories == $value->id_sub_category): ?>
                                    <option value="<?= rtrim(base64_encode($category->id_sub_categories),'='); ?>" selected="selected"><?= $category->name;?></option>
                                    <?php else: ?>
                            ...
                            <input type="hidden" name="id" value="<?=  rtrim(base64_encode($value->id_sub_sub_categories),'=');?>" ?>
...
<script type="text/javascript">
    ...
    function get_action() {
        return '<?= base_url(); ?>admin/Categories/update_sub_sub_category';
    }
</script>
<script type="text/javascript">
